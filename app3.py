...
st.title("SignSync: 영어 수어(ASL) 동영상 업로드, VideoMAE 수어 번역 및 자막 생성 데모")
st.markdown("ASL(영어 수어) 동영상 파일을 업로드하면 프레임을 추출하고, VideoMAE 수어 번역 모델로 자막을 생성해 영상에 입힙니다.")
